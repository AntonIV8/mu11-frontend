      ...
      nodes: [
        {
          ...
          link: null,
          caption: i18n.t('forms.application.sitemap.mu11.caption'),
          title: i18n.t('forms.application.sitemap.mu11.title'),
          children: [{
            link: 'i-i-s-mu11-f1-l',
            caption: i18n.t('forms.application.sitemap.mu11.i-i-s-mu11-f1-l.caption'),
            title: i18n.t('forms.application.sitemap.mu11.i-i-s-mu11-f1-l.title'),
            children: null
          }]
        }
      ]
